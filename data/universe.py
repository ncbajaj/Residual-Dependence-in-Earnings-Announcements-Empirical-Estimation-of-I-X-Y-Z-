"""
S&P 500 constituent list — 2024 snapshot.

SURVIVORSHIP BIAS WARNING: This is a point-in-time snapshot of constituents
as of early 2024. Companies that were removed from the S&P 500 before 2024
(due to bankruptcy, delisting, acquisition, or index rebalancing) are absent.
Any backtest or empirical study using only these tickers will overestimate
returns because it conditions on firms having survived to 2024. For rigorous
I(X;Y|Z) estimation, a survivorship-bias-free universe (e.g., Compustat
point-in-time files) is strongly preferred.
"""
...
SP500_TICKERS_2024 = [
    ...
    "BSX", "BMY", "AVGO", "BR", "BRO", "BF.B", "BLDR", "CHRW", "CDNS", "CZR",
    ...
    "D", "DPZ", "DOV", "DHI", "DTE", "DUK", "DD", "EMN", "ETN", "EBAY",
    ...
    "OMC", "ON", "OKE", "ORCL", "OTIS", "PCAR", "PKG", "PANW", "PH", "PAYX",
...
# Convenience subsets for development / smoke tests
DEV_TICKERS = ["AAPL", "MSFT", "JPM"]
